                    ...
                    <!-- <div class="col-lg-4">
                        <div class="ibox">
                            <div class="ibox-head">
                                ...
                                <div>
                                    <a class="btn btn-info btn-sm" href="<?= base_url('assets'); ?>javascript:;">New Task</a>
                                </div>
                            </div>
                            <div class="ibox-body">
                                <ul class="list-group list-group-divider list-group-full tasks-list">
                                    <li class="list-group-item task-item">
                                        ...
                                        <div class="task-actions">
                                            <a href="<?= base_url('assets'); ?>javascript:;"><i class="fa fa-edit text-muted m-r-10"></i></a>
                                            <a href="<?= base_url('assets'); ?>javascript:;"><i class="fa fa-trash text-muted"></i></a>
                                        </div>
                                    </li>
                                    <li class="list-group-item task-item">
                                        <div>
                        ...
                        <!-- <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="<?= base_url('assets'); ?>javascript:;">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="<?= base_url('assets'); ?>javascript:;">
                                            <img src="<?= base_url('assets'); ?>./img/image.jpg" width="50px;" />
                                        </a>
                                        <div class="media-body">
                                            <div class="media-heading">
                                                <a href="<?= base_url('assets'); ?>javascript:;">Samsung</a>
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-heading">
                                                <a href="<?= base_url('assets'); ?>javascript:;">iPhone</a>
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-heading">
                                                <a href="<?= base_url('assets'); ?>javascript:;">iMac</a>
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-heading">
                                                <a href="<?= base_url('assets'); ?>javascript:;">apple Watch</a>
                            ...
                            <div class="ibox-footer text-center">
                                <a href="<?= base_url('assets'); ?>javascript:;">View All Products</a>
                            </div>
                        </div>
                    </div>
                </div> -->
